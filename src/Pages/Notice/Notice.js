      ...
      <section className="text-gray-600 body-font py-20 ">
        <div className="container px-5 py- mx-auto">
          <div className="text-center mb-20">
            <h1 className="sm:text-3xl text-2xl font-bold text-center title-font text-gray-900 mb-4">Latest Notice</h1>

          </div>

          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2 backdrop-blur-sm">
            <div className="p-2 sm:w-1/2 w-full">
              <div className="bg-gray-100 rounded flex p-4 h-full items-center" data-aos="fade-up">
          ...
          <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Details</button>
        </div>
      </section>
    </div>
  );
