...
const Footer = () => {
	return (
		<div>
			<footer class="px-4 divide-y bg-gray-800 text-gray-100 pt-14">
				<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
					<div class="lg:w-1/3">
						<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
							...
							<span class="self-center text-2xl font-semibold">Govt. Mahtab Uddin Degree College Kaliganj, Jhenaidah </span>
						</a>
					</div>
				...
				<div class="py-6 text-sm text-center text-gray-400">© Saeed Internet 2022. All rights reserved.</div>
			</footer>
		</div>
	);
};
